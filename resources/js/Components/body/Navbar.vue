...
<template>
    ...
    <nav class="bg-navs px-1 py-1 border-b border-zinc-900 border-transparent drop-shadow-md">
        ...
        <div class="flex flex-row justify-between py-1 px-1 mx-auto md:container items-center">
            ...
            <button @click="$emit('update:menuIsOpen', !menuIsOpen); toggle()" id="button" class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-white">

                <span class="sr-only">Открыть главное меню</span>

                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path v-if="!menuIsOpen" stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                    <path v-if="menuIsOpen" stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
            ...
            <div class="inline-flex">
                ...
                <button @click="isOpen = !isOpen" class="p-2 text-gray-400 hover:text-white">
                    ...
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <path v-if="!isOpen" stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
    ...
    >
        <div v-if="isOpen" :class="{ block: isOpen, hidden: !isOpen  }" class="px-4 py-4 bg-navs md:absolute right-0 top-[70px] drop-shadow-md" id="menu">
